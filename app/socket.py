...
if os.environ.get('FLASK_ENV') == 'production':
  origins = [
    'https://accord-appp.herokuapp.com/',
    'http://accord-appp.herokuapp.com/'
  ]
else:
  origins = '*'

socketio = SocketIO(allowEIO3: true, cors_allowed_origins=origins, logger=True, engineio_logger=True, )
